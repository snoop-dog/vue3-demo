					...
					<div className='login-box'>
						<div className='login-box-ctx'>
							<div className='login-input-item'>
								...
								<Input class='input-item-value' placeholder='账号' type='text' value={this.userNmae} onInput={this.input} />
							</div>
							<div className='login-input-item'>
								{/* <span className='input-item-label'>密码：</span> */}
								<Input class='input-item-value' placeholder='密码' type='password' value={this.passWord} onInput={this.input} />
							</div>
						</div>
					</div> 

					<div className='login-footer'>
						<Button type='primary' class='login-btn' onClick={this.submitLogin}>登录</Button>
					</div>
				</div>
			</div>
		)
