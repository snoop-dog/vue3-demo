					...
					<div className='login-box'>
						<div className='login-box-ctx'>
							<div className='login-input-item'>
								...
								<input className='input-item-value' placeholder='请输入账号' type='text' autoComplete='off' value={this.userNmae} onInput={this.input} />
							</div>
							<div className='login-input-item'>
								{/* <span className='input-item-label'>密码：</span> */}
								<input className='input-item-value' placeholder='请输入密码' type='password' autoComplete='off' value={this.passWord} onInput={this.input} />
							</div>
						</div>
					</div> 
